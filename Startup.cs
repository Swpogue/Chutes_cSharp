...
public class Startup
{
  ...
  public void ConfigureServices(IServiceCollection services)
  {
    ...
    {
      c.SwaggerDoc("v1", new OpenApiInfo { Title = "Chutes_cSharp", Version = "v1" });
    });
    ...
    services.AddSingleton<ChutesRepository>();
    services.AddTransient<ChutesService>();
  }
